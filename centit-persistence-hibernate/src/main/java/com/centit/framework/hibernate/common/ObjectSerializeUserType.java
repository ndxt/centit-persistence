 ...
 * <p>
 *  自定义hibernate数据类型
 *  在Hibernate in Action一书中讲自定义hibernate数据类型因成为开发者的基础技能。
 *  个人感觉在hibernate中有多少种数据类型还没搞清楚了，还去自定义数据类型。。。。
 *
 *  Object序列化/反序列化
 *  数据库中以hex字符串存储
 *
 *  使用示例
 *  将@Type(type="com.centit.oa.common.hibernate.type.ObjectSerializeUserType")注解到bean的属性或get上去
 *
 * </p>
 *
 * @author AllanLoo
